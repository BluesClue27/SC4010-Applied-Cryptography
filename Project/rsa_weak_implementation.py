...
# Save parameters to values.py for use in attacks
print("💾 Saving parameters to values.py...")
with open('values.py', 'w') as f:
    f.write("# Weak RSA Parameters Generated by rsa_weak_implementation.py\n")
    f.write("# WARNING: These parameters are INTENTIONALLY VULNERABLE for educational purposes\n")
    f.write(f"# Generated on: {time.strftime('%Y-%m-%d %H:%M:%S')}\n")
    f.write("\n")
    f.write(f"p = {p}\n")
    f.write(f"q = {q}\n")
    f.write(f"N = {n}\n")
    f.write(f"phi_n = {phi_n}\n")
    f.write(f"e = {e}\n")
    f.write(f"d = {d}\n")
    f.write("\n")
    f.write(f"# Bit lengths\n")
    f.write(f"p_bits = {p.bit_length()}\n")
    f.write(f"q_bits = {q.bit_length()}\n")
    f.write(f"N_bits = {n.bit_length()}\n")
    f.write(f"d_bits = {d.bit_length()}\n")
    f.write(f"e_bits = {e.bit_length()}\n")
    f.write("\n")
    f.write(f"# Vulnerability metrics\n")
    f.write(f"prime_gap = abs(p - q)  # = {abs(p - q)}\n")
    f.write(f"prime_gap_bits = {abs(p - q).bit_length()}\n")
print("✓ Parameters saved to values.py")
print()
...
# Save values to values.py for breaking_rsa.py
with open('Project/values.py', 'w') as f:
    f.write(f"# RSA values generated by rsa_weak_implementation.py\n")
    f.write(f"n = {n}\n")
    f.write(f"e = {e}\n")
    f.write(f"p = {p}\n")
    f.write(f"q = {q}\n")
...
print("Values saved to values.py")